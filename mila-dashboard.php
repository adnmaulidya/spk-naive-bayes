...
<div class="container">
	<nav class="navbar navbar-inverse" role="navigation">
		...
		<div class="navbar-header">
			...
			<a class="navbar-brand" href="./">Sistem Mahasiswa Berprestasi</a>
		</div>
					...
					<div class="carousel-inner">
						<div class="item active">
							...
							<div class="carousel-caption">
								<h3>NIM: 1741720114</h3>
								<p>Mahasiswi S1 Teknik Informatika Politeknik Negeri Malang</p>
							</div>
						</div>
						<!-- End Item -->
						<div class="item">
							...
							<div class="carousel-caption">
								<h2>Penyeleksian Mahasiswa Berprestasi (Mawapres)</h2>
								<h3>Menggunakan Algoritma Naive Bayes</h3>
							</div>
						</div>
						<!-- End Item -->
						<div class="item">
